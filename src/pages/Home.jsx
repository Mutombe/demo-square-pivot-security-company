    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      >
        ...
        <div className="overflow-hidden">
          {['PROTECTING', 'WHAT MATTERS', 'MOST.'].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
            ...
            >
              <h1
                ...
                style={{
                  ...
                  fontWeight: line === 'WHAT MATTERS' ? 700 : 300,
                }}
              >
                {line}
              </h1>
        ...
        >
          ...
          <p className="text-white/30 text-xs sm:text-sm uppercase tracking-[0.2em]" style={{ fontFamily: 'var(--font-sans)' }}>
            400+ Installations &middot; 6 Years &middot; 24/7 Monitoring
          </p>
        </motion.div>
      ...
      <div className="hidden lg:flex absolute right-8 bottom-12 z-20">
        ...
        >
          Square Pivot Security Company &mdash; Harare, Zimbabwe
        </span>
      </div>
    </section>
  );
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <div className="flex gap-10 sm:gap-16">
              <div>
                <div className="text-red-600 font-heading text-3xl sm:text-4xl italic leading-none">2018</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Founded</div>
              </div>
              <div>
                <div className="text-red-600 font-heading text-3xl sm:text-4xl italic leading-none">400+</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Served</div>
              </div>
              <div>
                <div className="text-red-600 font-heading text-3xl sm:text-4xl italic leading-none">6+</div>
            ...
            <div className="relative">
              <div className="overflow-hidden">
                <img
                  ...
                  alt="Square Pivot Security Company"
              ...
              <div className="absolute -bottom-8 -left-6 sm:-left-10 w-[45%] overflow-hidden border-4 border-navy-950 shadow-2xl">
                <img
                  ...
                  alt="Square Pivot Security Company team"
              ...
              <div className="absolute -top-4 -right-4 sm:-right-6 bg-red-600 text-white p-5 sm:p-7 shadow-2xl">
                <div className="text-center">
                  ...
                  <div className="font-heading text-3xl sm:text-4xl italic leading-none mt-1">2018</div>
                </div>
              </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            ...
            <h2 className="font-heading text-white leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-red-600">Square</span>
            </h2>
...
function CTASection() {
  ...
  return (
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img src={homeCta.backgroundImage} alt="Square Pivot Security Company" className="w-full h-[130%] object-cover object-center" loading="lazy" />
