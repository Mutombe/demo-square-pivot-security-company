...
const siteData = {
  business: {
    name: "Square Pivot Security Company",
    legalName: "Square Pivot Security Company",
    tagline: "Smart Security for Modern Zimbabwe",
    description: "Square Pivot Security Company delivers comprehensive security solutions from CCTV and alarm systems to access control and guarding services. Protecting Harare's homes and businesses with intelligent technology.",
    phone: "+263 71 697 0702",
    phoneRaw: "+263716970702",
    whatsappNumber: "263716970702",
    email: "info@squarepivotsecurity.co.zw",
    address: "Galaxy mall office, First street and Jason moyo, 39 third floor, Harare, Zimbabwe",
    country: "Zimbabwe",
    city: "Harare",
    rating: 5,
    ratingRounded: 5,
    ...
    cookieConsentKey: "square-pivot-security-company-cookie-consent",
    socialLinks: {
      facebook: "#",
      instagram: "#",
      linkedin: "#",
  ...
  navbar: {
    logoImage: null,
    logoLine1: "Square",
    logoLine2: "Pivot Security",
  },

  hero: {
    badge: "Harare's Intelligent Security Solutions Provider",
    titleParts: [
      { text: "PROTECTING" },
      { text: "WHAT MATTERS", highlight: true },
      { text: "MOST." },
    ],
    subtitle: "Square Pivot Security Company delivers comprehensive security solutions from CCTV and alarm systems to access control and guarding services. Protecting Harare's homes and businesses with intelligent technology.",
    ctaPrimary: "Get Protected",
    ctaSecondary: "Free Assessment",
    trustBadge: "400+ Clients Served",
    backgroundImages: [
  ...
  stats: [
    { number: "400+", label: "Installations Done" },
  ...
  homeTestimonials: [
    { text: "Square Pivot Security Company installed a complete CCTV system at my home and I finally feel safe. The cameras are crystal clear and I can check my phone from anywhere.", name: "Wellington Moyo", role: "Homeowner, Borrowdale", rating: 5, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" },
    { text: "We contracted Square Pivot Security Company for our estate security and they delivered a fully integrated system -- cameras, access control, and electric fencing all working together.", name: "Chenai Dziva", role: "Property Manager", rating: 5, avatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=100&q=80" },
    { text: "Square Pivot Security Company installed security cameras at our school and the improvement in safety and accountability has been remarkable. Parents are very reassured.", name: "Tapiwa Gondo", role: "School Headmaster", rating: 5, avatar: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=100&q=80" },
    { text: "The alarm system Square Pivot Security Company installed has already paid for itself. Fast response, reliable monitoring, and their technicians are always available when needed.", name: "Martha Zvobgo", role: "Business Owner, CBD", rating: 5, avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&q=80" },
  ],
  ...
  about: {
    ...
    story: [
      "Square Pivot Security was founded in 2018 with a vision to bring intelligent, technology-driven security to Zimbabwean homes and businesses. We believe security should be smart, not just strong.",
      "With over 400 installations across Harare and a 24/7 monitoring centre, we provide layered security solutions that deter, detect, and respond to threats in real-time.",
    ],
    values: [
    ...
    team: [
      { name: "Team Leader", role: "Director", bio: "Leading Square Pivot Security Company with expertise and vision.", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80" },
  ...
  reviews: {
    ...
    items: [
      { text: "Square Pivot Security Company installed a complete CCTV system at my home and I finally feel safe. The cameras are crystal clear and I can check my phone from anywhere.", name: "Wellington Moyo", role: "Homeowner, Borrowdale", rating: 5 },
      { text: "We contracted Square Pivot Security Company for our estate security and they delivered a fully integrated system -- cameras, access control, and electric fencing all working together.", name: "Chenai Dziva", role: "Property Manager", rating: 5 },
      { text: "Square Pivot Security Company installed security cameras at our school and the improvement in safety and accountability has been remarkable. Parents are very reassured.", name: "Tapiwa Gondo", role: "School Headmaster", rating: 5 },
      { text: "The alarm system Square Pivot Security Company installed has already paid for itself. Fast response, reliable monitoring, and their technicians are always available when needed.", name: "Martha Zvobgo", role: "Business Owner, CBD", rating: 5 },
      { text: "Remote viewing works perfectly. I can see my house from my office phone thanks to Square Pivot Security Company's CCTV setup.", name: "Simba Karonga", role: "Remote Monitoring Client", rating: 5 },
      { text: "Electric fence installation was done in one day with minimal disruption. Square Pivot Security Company are efficient and tidy.", name: "Douglas Mhizha", role: "Homeowner", rating: 5 },
      { text: "The access control system Square Pivot Security Company installed at our offices has completely eliminated unauthorised entry.", name: "Linda Masuku", role: "Corporate Client", rating: 5 },
      { text: "Night vision on these cameras is incredible. Square Pivot Security Company recommended the right specs for our needs.", name: "Patrick Makoni", role: "Night Security Client", rating: 5 },
      ...
      { text: "Annual maintenance contract with Square Pivot Security Company keeps everything working perfectly. Proactive, not reactive.", name: "Brian Mutema", role: "Maintenance Client", rating: 5 },
    ],
  },
  ...
  contact: {
    ...
    branches: [
      { name: "Main Office", address: "Galaxy mall office, First street and Jason moyo, 39 third floor, Harare, Zimbabwe", phone: "+263 71 697 0702", email: "info@squarepivotsecurity.co.zw" },
    ],
  },
  ...
  homeCta: {
    ...
    whatsappText: "Hello Square Pivot! I need a security assessment.",
    backgroundImage: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1920&q=85",
  },

  footer: {
    description: "Square Pivot Security Company delivers comprehensive security solutions from CCTV and alarm systems to access control an...",
    copyright: "Square Pivot Security Company",
  },
};
